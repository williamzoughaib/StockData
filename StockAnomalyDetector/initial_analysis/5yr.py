...
DATA_PATH = ROOT_DIR / "5yr_data"  # Equivalent to data/raw in example
...
for ticker_name, df in dfs.items():
    ...
    fig.suptitle(f'{ticker_name} - 5 Year Analysis', fontsize=16, fontweight='bold')
    ...
    # Save plot
    output_file = f"{ticker_name}_5yr_analysis.png"
